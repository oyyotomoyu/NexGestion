...
- `notification.db`: Notification types, messages, audiences, delivery state, export metadata, and lifecycle events
- `report/`: Generated CSV report files for admin review, download, backup, and deletion
